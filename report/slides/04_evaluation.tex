...
\begin{frame}{ROC Curve}
  \begin{figure}
    \centering
    \includegraphics[width=\textwidth,height=0.65\textheight,keepaspectratio]{roc_curve.png}
  \end{figure}
\end{frame}
...
\begin{frame}{Confusion Matrix}
  \begin{figure}
    \centering
    \includegraphics[width=\textwidth,height=0.65\textheight,keepaspectratio]{confusion_matrix.png}
  \end{figure}
\end{frame}
