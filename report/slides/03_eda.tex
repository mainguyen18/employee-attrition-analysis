...
\begin{frame}{Tỷ lệ nghỉ việc theo OverTime}
  \begin{figure}
    \centering
    \includegraphics[width=\textwidth,height=0.65\textheight,keepaspectratio]{churn_rate_by_OverTime.png}
  \end{figure}
...
\begin{frame}{Tỷ lệ nghỉ việc theo JobRole}
  \begin{figure}
    \centering
    \includegraphics[width=\textwidth,height=0.65\textheight,keepaspectratio]{churn_rate_by_JobRole.png}
  \end{figure}
...
\begin{frame}{Phân phối Age theo trạng thái nghỉ việc}
  \begin{figure}
    \centering
    \includegraphics[width=\textwidth,height=0.65\textheight,keepaspectratio]{dist_Age_by_churn.png}
  \end{figure}
...
\begin{frame}{Phân phối MonthlyIncome theo trạng thái nghỉ việc}
  \begin{figure}
    \centering
    \includegraphics[width=\textwidth,height=0.65\textheight,keepaspectratio]{dist_MonthlyIncome_by_churn.png}
  \end{figure}
...
\begin{frame}{Phân phối YearsAtCompany theo trạng thái nghỉ việc}
  \begin{figure}
    \centering
    \includegraphics[width=\textwidth,height=0.65\textheight,keepaspectratio]{dist_YearsAtCompany_by_churn.png}
  \end{figure}
